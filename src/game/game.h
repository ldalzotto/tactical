...
// Returns the byte shift game->scratch's growth applied while handling this
// event (0 if none), so app.c can rebase anything else it holds above
// game->scratch (see app_dispatch_input_events).
